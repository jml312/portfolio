...
const hasSubmittedQuery = `defined(*[_type == 'submissions' && lower(name) == lower($name) && lower(email) == lower($email)])`;

const hasIpQuery = `defined(*[_type == "pageViews" && $slug == slug && $ip in locations[].ip][0])`;
